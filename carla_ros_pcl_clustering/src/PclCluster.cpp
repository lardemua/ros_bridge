...
void PclCluster::callback_lidar_front(const PCLPointCloud2::ConstPtr& cloud)
{
...
void PclCluster::callback_lidar_left(const PCLPointCloud2::ConstPtr& cloud)
{
    if ((cloud->width * cloud->height) == 0) {
        return;
    }
...
void PclCluster::callback_lidar_right(const PCLPointCloud2::ConstPtr& cloud)
{
    if ((cloud->width * cloud->height) == 0) {
        return;
    }
