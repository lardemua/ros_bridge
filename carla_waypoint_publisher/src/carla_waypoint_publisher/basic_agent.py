...
class BasicAgent(Agent):
    """
    The BasicAgent class implements a basic agent that navigates scenes to reach a given
    target destination. This agent respects traffic lights and other vehicles.
    """

    def __init__(self, vehicle, target_speed=20):
        """
        Constructor for BasicAgent class.
    ...
    def set_destination(self, location):
        """
        Function used to create a list of waypoints from agent's position to destination location
