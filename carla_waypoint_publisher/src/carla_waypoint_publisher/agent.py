...
class AgentState(Enum):
    """
    This class represents the possible states of a roaming agent
    """
    NAVIGATING = 1
...
class Agent(object):
    """
    Base Class used to define agents in CARLA
    """
    ...
    def _is_light_red(self, lights_list):
        """
        Private function used to check if there is a red light affecting us. This version of
    ...
    def _is_light_red_us_style(self, lights_list, debug=False):
        """
        Private function specialized to check US style traffic lights.
    ...
    def emergency_stop(self):
        """
        Function used to send an emergency stop command to the vehicle
        :return:
        """
        control = carla.VehicleControl()
        control.steer = 0.0
