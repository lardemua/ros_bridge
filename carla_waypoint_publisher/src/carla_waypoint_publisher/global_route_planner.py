...
class GlobalRoutePlanner(object):
    ...
    Instantiate the class by passing a reference to a GlobalRoutePlannerDAO object.
    """

    def __init__(self, dao):
        """
        Constructor for GlobalRoutePlanner class
        """
        self._dao = dao
        self._topology = None
        self._graph = None
    ...
    def setup(self):
        """
        Function used to perform initial server data lookup for detailed topology
    ...
    def _build_graph(self):
        """
        Private function used to build a networkx  graph representation of topology.
    ...
    def _localize(self, location):
        """
        Private function used to find the road segment closest to given location
    ...
    def _lane_change_link(self):
        """
        Private function used to place zero cost links in the topology graph
    ...
    def _distance_heuristic(self, n1, n2):
        """
        Private function used to calculate the heuristic distance for path searching
        in self._graph
        """
    ...
    def _path_search(self, origin, destination):
        """
        Private function used to find the shortest path connecting origin and destination
    ...
    def _turn_decision(self, index, route, threshold=math.radians(5)):
        """
        Private function used to return the turn decision (RoadOption) for pair of edges
    ...
    def abstract_route_plan(self, origin, destination):
        """
        Function used to generate the route plan based on
    ...
    def _find_closest_in_list(self, current_waypoint, waypoint_list):
        """
        Private function used to find the closest waypoint the waypoint list
        :param current_waypoint: current waypoint
        :param waypoint_list: list of waypoints
        :return:
        """
    ...
    def trace_route(self, origin, destination):
        """
        Function used to return a list of (carla.Waypoint, RoadOption) from origin to destination
        """
        route_trace = []
        route = self._path_search(origin, destination)
