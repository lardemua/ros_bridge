...
class RoadOption(Enum):
    """
    This class represents the possible topological configurations when moving from a segment of a lane to another
    """
    VOID = -1
    LEFT = 1
    RIGHT = 2
...
class LocalPlanner(object):
    ...
    def _init_controller(self, opt_dict):
        ...
        args_lateral_dict = {'K_P': 1.95, 'K_D': 0.01, 'K_I': 1.4, 'dt': self._dt}
    ...
    def _compute_next_waypoints(self, k=1):
        ...
        for _ in range(k):
            ...
            if len(next_waypoints) == 1:
                ...
                road_options_list = self._retrieve_options(next_waypoints, last_waypoint)
