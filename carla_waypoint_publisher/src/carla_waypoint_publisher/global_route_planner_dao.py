...
class GlobalRoutePlannerDAO(object):
    ...
    def __init__(self, wmap, sampling_resolution=1):
        """
        Constructor for GlobalRoutePlannerDAO class
        wmap    :   carla world map object
        sampling_resolution : carla world sample resolution
        """
    ...
    def get_topology(self):
        """
        Function used to access topology.
    ...
    def get_waypoint(self, location):
        """
        Function used to return a waypoint at given location
        """
    ...
    def get_resolution(self):
        """
        Function used to return current sampling resolution
        :return:
        """
