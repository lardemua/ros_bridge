...
"""
Classes to handle Carla Atlas Vehicles
"""
...
class AtlasVehicle(Vehicle):

    """
    Vehicle implementation details for the Atlas vehicle
    """

    @staticmethod
    def create_actor(carla_actor, parent):
        """
        Static factory method to create atlas vehicle actors
        ...
        """
        return AtlasVehicle(carla_actor=carla_actor, parent=parent)
    ...
    def __init__(self, carla_actor, parent):
        ...
        :type parent: carla_ros_bridge.Parent
        """
        super(AtlasVehicle, self).__init__(carla_actor=carla_actor,
                                           parent=parent,
    ...
    def get_marker_color(self):
        ...
        The atlas vehicle uses a different marker color than other vehicles.
    ...
    def send_vehicle_msgs(self):
        """
        Function (override) to send odometry message of the atlas vehicle
    ...
    def update(self):
        ...
        :return:
        """
        objects = super(AtlasVehicle, self).get_filtered_objectarray(self.carla_actor.id)
        self.publish_ros_message(self.topic_name() + '/objects', objects)
        self.send_vehicle_msgs()
        super(AtlasVehicle, self).update()
    ...
    def destroy(self):
        ...
        super(AtlasVehicle, self).destroy()
    ...
    def enable_autopilot_updated(self, enable_auto_pilot):
        ...
        :return:
        """
        rospy.logdebug("Atlas vehicle: Set autopilot to {}".format(enable_auto_pilot.data))
    ...
    def get_vehicle_speed_squared(carla_vehicle):
        ...
        :rtype: float64
        """
        return AtlasVehicle.get_vector_length_squared(carla_vehicle.get_velocity())
    ...
    def get_vehicle_speed_abs(carla_vehicle):
        ...
        :rtype: float64
        """
        speed = math.sqrt(AtlasVehicle.get_vehicle_speed_squared(carla_vehicle))
        return speed
    ...
    def get_vehicle_acceleration_abs(carla_vehicle):
        ...
        :rtype: float64
        """
        return math.sqrt(AtlasVehicle.get_vector_length_squared(carla_vehicle.get_acceleration()))
