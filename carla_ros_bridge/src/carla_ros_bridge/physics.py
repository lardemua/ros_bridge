...
def get_vector_length_squared(carla_vector):
    """
    Function used to calculate the squared length of a Carla Vector
...
def get_vehicle_speed_squared(carla_vehicle):
    """
    Function used to get the squared speed of a Carla Vehicle
    :param carla_vehicle: The Carla Vehicle
    :type carla_vehicle: carla.Vehicle
    :return: Speed of a Carla Vehicle [(m/s)^2]
    :rtype: float64
    """
...
def get_vehicle_speed_abs(carla_vehicle):
    """
    Function used to get the absolute speed of a Carla Vehicle
    :param carla_vehicle: The Carla Vehicle
    :type carla_vehicle: carla.Vehicle
...
def get_vehicle_acceleration_abs(carla_vehicle):
    """
    Function used to get the absolute acceleration of a Carla Vehicle
    :param carla_vehicle: The Carla Vehicle
    :type carla_vehicle: carla.Vehicle
...
def get_vehicle_driving_direction_sign(carla_vehicle):
    """
    Function used to get the driving direction of the Carla Vehicle as a sign
    :param carla_vehicle: The Carla Vehicle
    :type carla_vehicle: carla.Vehicle
...
def get_vehicle_speed(carla_vehicle):
    """
    Function used to get the signed speed of a Carla Vehicle
    :param carla_vehicle: The Carla Vehicle
    :type carla_vehicle: carla.Vehicle
    :return: Speed of a Carla Vehicle [m/s >= 0]
    :rtype: float64
...
def get_vehicle_mass(carla_vehicle):
    """
    Function used to get the mass of a Carla Vehicle (default -> 1500kg)
    :param carla_vehicle: The Carla Vehicle
    :type carla_vehicle: carla.Vehicle
    :return: Mass of a Carla Vehicle
    :rtype: float64
    """
    mass = carla_vehicle.attributes.get('mass', 1500.0)
    return mass


def get_acceleration_of_gravity(dummy_carla_vehicle):
    """
    Function used to get the acceleration of gravity for a Carla Vehicle
    (for the moment constant at 9.81 m/s^2)
    :param dummy_carla_vehicle: The Carla Vehicle
    :type dummy_carla_vehicle: carla.Vehicle
...
def get_weight_force(carla_vehicle):
    """
    Function used to get the weight of a Carla Vehicle
    :param carla_vehicle: The Carla Vehicle
    :type carla_vehicle: carla.Vehicle
...
def get_vehicle_max_speed(carla_vehicle):
    """
    Function used to get the maximum speed of a Carla Vehicle
    :param carla_vehicle: The Carla Vehicle
    :type carla_vehicle: carla.Vehicle
    ...
    max_speed = carla_vehicle.attributes.get('max_speed', 180.0 / 3.6)
    return max_speed


def get_vehicle_max_acceleration(carla_vehicle):
    """
    Function used to get the maximum acceleration of a Carla Vehicle
    ...
    :rtype: float64
    """
    max_acceleration = carla_vehicle.attributes.get('max_acceleration', 3.0)
    return max_acceleration


def get_vehicle_max_deceleration(carla_vehicle):
    """
    Function used to get the maximum deceleration of a Carla Vehicle
    Default: 8 m/s^2
    :param carla_vehicle: The Carla Vehicle
    :type carla_vehicle: carla.Vehicle
    :return: Maximum Acceleration [m/s^2 > 0]
    :rtype: float64
    """
    max_deceleration = carla_vehicle.attributes.get('max_deceleration', 8.0)
    return max_deceleration


def get_aerodynamic_drag_force(carla_vehicle):
    """
    Function used to calculate the aerodynamic drag force of a Carla Vehicle
    :param carla_vehicle: The Carla Vehicle
    :type carla_vehicle: carla.Vehicle
    ...
    drag_area = carla_vehicle.attributes.get('drag_area',
...
def get_rolling_resistance_force(carla_vehicle):
    """
    Function used to calculate the rolling resistance force of a Carla Vehicle
    :param carla_vehicle: The Carla Vehicle
    :type carla_vehicle: carla.Vehicle
...
def get_slope_force(carla_vehicle):
    """
    Function used to calculate the force of a Carla Vehicle faces when driving on a slope
    :param carla_vehicle: The Carla Vehicle
    :type carla_vehicle: carla.Vehicle
...
def get_vehicle_lay_off_engine_acceleration(carla_vehicle):
    """
    Function used to calculate the acceleration of a Carla Vehicle faces by the engine on lay off
    This respects the following forces: - Engine Brake Force
    :param carla_vehicle: The Carla Vehicle
    :type carla_vehicle: carla.Vehicle
    :return: Acceleration of the Vehicle [m/s^2 < 0]
    :rtype: float64
    """
...
def get_vehicle_driving_impedance_acceleration(carla_vehicle, reverse):
    """
    Function used to calculate the acceleration a Carla Vehicle faces by the driving impedance
    ...
    :param carla_vehicle: The Carla Vehicle
    :type carla_vehicle: carla.Vehicle
    :param reverse: True if the vehicle is driving in the reverse direction
