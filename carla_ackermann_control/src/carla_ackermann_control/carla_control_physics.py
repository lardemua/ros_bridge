...
"""
Tool Functions used to calculate Vehicle Physics
"""
...
def get_vehicle_lay_off_engine_acceleration(vehicle_info):
    """
    Function used to calculate the acceleration a Carla Vehicle faces by the engine on lay off.
    This respectis the following forces: - Engine Brake Force
...
def get_engine_brake_force(_):
    """
    Function used to calculate the engine brake force of a Carla Vehicle if the gas pedal would be layed off
    ...
    :param _: the vehicle info
    :type _: carla_ros_bridge.CarlaEgoVehicleInfo
...
def get_vehicle_mass(vehicle_info):
    """
    Function used to get the mass of a Carla Vehicle (defaults to 1500kg)
...
def get_vehicle_driving_impedance_acceleration(vehicle_info, vehicle_status, reverse):
    ...
    This respects the following forces: - Rolling Resistance Force
...
def get_vehicle_max_steering_angle(vehicle_info):
    """
    Function used to het the maximum steering angle of a Carla Vehicle
    :param vehicle_info: the vehicle info
    :type vehicle_info: carla_ros_bridge.CarlaEgoVehicleInfo
