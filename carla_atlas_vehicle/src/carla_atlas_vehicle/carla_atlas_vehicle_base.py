...
# ==============================================================================
# -- CarlaAtlasVehicleBase -----------------------------------------------------
# ==============================================================================
class CarlaAtlasVehicleBase(object):
    """
    Class used to handle the spawning of the Atlas Vehicle and its sensors.
    Derive from this class and implement method sensors()
    """
    def __init__(self):
        """
        Constructor for CarlaAtlasVehicleBase Class
        """
