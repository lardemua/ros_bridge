...
// Foundation, Inc., 59 Temple Place, Suite 330, Boston, MA  02111-1307  ifndef PROJECT_EKFILTER_IMPLe PROJECT_EKFILTER_IMPLe KALMAN_N_MODIFIED

#ifndef ROS_BRIDGE_EKFILTER_IMPL_HPP
#define ROS_BRIDGE_EKFILTER_IMPL_HPP
...
namespace Kalman {
    ...
    EKFilter<T, BEG, OQ, OVR, DBG>::EKFilter() : flags(0) {
        setDim(0, 0, 0, 0, 0);
    }
...
#endif //ROS_BRIDGE_EKFILTER_IMPL_HPP
